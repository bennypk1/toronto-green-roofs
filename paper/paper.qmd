...
Faced with these unique risks, many municipalities around the world (e.g. Dublin, Ireland and Berlin, Germany) have adopted green roof by-laws (hereafter referred to as GRBLs) to mitigate against the UHI [@basu_theoretical_2021 ; @ngan_tools_nodate]. Green roofs are defined by Berardi et al. [@berardi_2014] as "roofs with plants in their final layer", and offer many building-level and city-level services including stormwater management and increased public access to nearby green spaces [@berardi_2014]. Most importantly for this report, green roofs decrease the overall solar absorbance of an urban area by increasing total vegetated area, with albedos (a measure of surface reflectivity) typically ranging from 0.7 - 0.85, as compared to standard roofing materials (0.1 - 0.2 ; @berardi_2014). This difference has been shown to have cooling effects at local and neighborhood scales [@aram_urban_2019].
...
We observe a negative association (p < 0.05, for a linear model on a log-log scale) between green space coverage and green roof coverage among Toronto's FSAs, shown in @fig-scatter.
